var express = require('express'),
    ...
    JobService = require('./routes/JobService.min').JobService,
    manualService = require('./routes/ManualService.min').ManualService,
    taskService = require('./routes/TaskService.min').TaskService,
    idGenerationService = require('./routes/IDGenerationService.min').IDGenerationService,
    jobcardService = require('./routes/JobCardService.min').JobCardService,    
    partService = require('./routes/PartService.min').PartService,    
    authService = require('./routes/AuthenticationService.min').AuthenticationService,    
    fs = require("fs"),
